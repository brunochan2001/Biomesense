...
clickme.addEventListener(`click`, (e) => {
  ...
  } else e.target.classList.replace(`gren`, `active-bg`);
});

window -
  addEventListener(`click`, () => {
    const animacion10 = this.document.getElementById(`transition-10`);
    animacion10.style.animation = `translate-2 1s ease-out`;
  });
